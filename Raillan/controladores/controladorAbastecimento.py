...
class ControladorAbastecimento:
    ...
    def verificar_abastecimento(self, idBomba, tipoCombustivel, preco, litros):
        ...
        # Verificar se o tipo de combustível é compatível com a bomba
        if bomba[2] != tipoCombustivel:
            raise Exception("O tipo de combustível selecionado não é compatível com a bomba.")
